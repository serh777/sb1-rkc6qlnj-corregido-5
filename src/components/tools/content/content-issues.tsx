...
export function ContentIssues({ issues }: ContentIssuesProps) {
  return (
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full ${
                    ...
                    issue.type === 'technical' ? 'bg-blue-100 text-blue-800' :
                    issue.type === 'seo' ? 'bg-green-100 text-green-800' :
